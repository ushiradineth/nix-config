return {
	...
	config = function()
		...
		vim.keymap.set("n", "<leader>gc", builtin.git_bcommits, { noremap = true, silent = true, desc = "Commits" })

		-- List the current git repository's history
		vim.keymap.set("n", "<leader>grc", builtin.git_commits, { noremap = true, silent = true, desc = "Commits" })

		-- List the changed files in the current git repository
		vim.keymap.set("n", "<leader>gs", builtin.git_status, { noremap = true, silent = true, desc = "Changes" })
